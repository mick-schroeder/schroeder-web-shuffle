...
Wish to shuffle through news sites directly from your bookmarks toolbar? Make it possible with our bookmarklet.

### Easy Method

- Drag this link to your browser's toolbar: [Web Shuffle](https://webshuffle.mickschroeder.com/redirect)

or if you like emoji...
...
3. In the URL section, insert: `https://webshuffle.mickschroeder.com/redirect`.
4. Click "Save" or "Add."
---
