...
import PressShuffleMachine from "../components/randomWebsiteMachine"
      ...
      <div className="w-full flex items-stretch justify-center bg-gray-100 dark:bg-gray-800">
        <div className="container p-10 text-center mt-10">
          <PressShuffleIcon
            ...
            height="120"
          />
          <h1 className="py-6 text-6xl uppercase tracking-tightest font-black text-gray-900 dark:text-gray-50 sm:text-4xl md:text-5xl">
            Press Shuffle
          </h1>
